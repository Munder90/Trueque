...
namespace TAT001.Entities
{
    ...
    public partial class TruequeEntities : DbContext
    {
        public TruequeEntities()
            : base("name=TruequeEntities")
        {
        }
        ...
        [DbFunction("TruequeEntities", "split")]
        public virtual IQueryable<split_Result> split(string delimited, string delimiter)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<split_Result>("[TruequeEntities].[split](@delimited, @delimiter)", delimitedParameter, delimiterParameter);
        }
        ...
        public virtual int CSP_MASIVA_CLIENTES(Nullable<int> aCCION)
        {
            var aCCIONParameter = aCCION.HasValue ?
                new ObjectParameter("ACCION", aCCION) :
                new ObjectParameter("ACCION", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("CSP_MASIVA_CLIENTES", aCCIONParameter);
        }
        ...
        public virtual int CSP_PRESU_CLIENT(string cLIENTE, string pERIODO)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("CSP_PRESU_CLIENT", cLIENTEParameter, pERIODOParameter);
        }
        ...
        public virtual ObjectResult<CSP_PROVISIONES_ABIERTAS_Result> CSP_PROVISIONES_ABIERTAS()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<CSP_PROVISIONES_ABIERTAS_Result>("CSP_PROVISIONES_ABIERTAS");
        }
